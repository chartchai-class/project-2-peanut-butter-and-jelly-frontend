...
<template>
  ...
  <RouterLink :to="{ name: 'countrymanaged-view'}" button class="absolute top-10 right-8 px-4 py-2 text-white bg-red-950 rounded hover:bg-red-900 focus:outline-none focus:ring-2 focus:ring-red- flex items-center">
